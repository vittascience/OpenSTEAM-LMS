        ...
        "parts" => [
            ...
            [
               ...
               Copier ce lien, puis cocher la case \"Activer l'API sur ce projet\".</p>
                <iframe width='800' height='500' frameborder='0' style='border:1px #d6d6d6 solid;' src=\"https://vittascience.com/code?frameid=ym6svtpod4&embed=1&id=42\" title=\"API Tutorial - Example program to understand APIs\"></iframe>"
            ],
            [
            ...
            [
                ...
                <iframe width='800' height='500' frameborder='0' style='border:1px #d6d6d6 solid;' src=\"https://vittascience.com/code?frameid=s6oq6xfhpf8&embed=1&id=43\" title=\"API Tutorial - Practical exercise to create your first API\"></iframe>"
            ],
        ],
