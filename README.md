...
- [vuser](https://github.com/vittascience/vuser) : current version (1.2.10)
...
- vlearn (not public yet) : current version (1.3.90)
- [vutils](https://github.com/vittascience/vutils) : current version (1.2.19)