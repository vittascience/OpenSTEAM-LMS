...
--
-- Hôte : mariadb
-- Généré le : ven. 28 mai 2021 à 06:50
...
--
CREATE DATABASE IF NOT EXISTS `steam-lms-db-empty` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `steam-lms-db-empty`;
