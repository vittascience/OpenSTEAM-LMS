...
--
-- Hôte : mariadb
-- Généré le : ven. 21 nov. 2025 à 11:57
...
CREATE DATABASE IF NOT EXISTS `opensteam` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `opensteam`;
...
CREATE TABLE `classrooms` (
  ...
  `uai` varchar(255) DEFAULT NULL,
  `gar_code` varchar(255) DEFAULT NULL
...
CREATE TABLE `classroom_activities_link_classroom_users` (
  ...
  `id_activity` int(11) NOT NULL,
  `reference` varchar(13) NOT NULL DEFAULT '123456789',
  ...
  `optional_data` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `interfaces_projects` (
  ...
  `project_name` varchar(100) NOT NULL DEFAULT 'Unamed',
  `interface` varchar(50) NOT NULL,
  `project_description` varchar(1000) DEFAULT 'No description',
  `date_updated` timestamp NULL DEFAULT current_timestamp(),
  `code` mediumtext NOT NULL,
  `code_mixed` mediumtext DEFAULT NULL,
  `code_language` mediumtext NOT NULL,
...
INSERT INTO `lang` (`id`, `name`, `langcode`, `path`, `available`) VALUES
(1, 'Français', 'fr', 'fr/ns.json', 1),
(2, 'English', 'en', 'en/ns.json', 1),
(3, 'русский', 'ru', 'ru/ns.json', 1),
(4, 'Português', 'pt', 'pt/ns.json', 0),
(5, 'Deutsch', 'de', 'de/ns.json', 1),
(6, '日本の', 'jp', 'jp/ns.json', 0),
(7, 'Italiano', 'it', 'it/ns.json', 1),
(8, 'Español', 'es', 'es/ns.json', 1),
(9, 'العربية', 'ar', 'ar/ns.json', 1),
(10, 'हिन्दी', 'in', 'in/ns.json', 0),
(11, '한국의', 'kr', 'kr/ns.json', 0),
(12, 'China', 'cn', 'cn/ns.json', 0);
...
CREATE TABLE `learn_activities` (
  ...
  `title` varchar(1000) DEFAULT 'No title',
  `content` varchar(10000) NOT NULL DEFAULT 'No content',
...
CREATE TABLE `learn_collections` (
  `id` int(11) NOT NULL,
  `name_collection` varchar(100) NOT NULL DEFAULT 'Unamed',
  `grade_collection` varchar(100) NOT NULL DEFAULT 'Unamed'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `learn_courses` (
  ...
  `lang` varchar(100) DEFAULT 'No lang',
  `support` int(11) DEFAULT 0,
  `img` varchar(10000) NOT NULL DEFAULT 'No image',
  `link` varchar(255) NOT NULL DEFAULT 'No link',
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp(),
  `is_deleted` tinyint(1) NOT NULL DEFAULT 0,
...
--
-- Structure de la table `lms_classroom_sessions`
--
...
--
-- Structure de la table `lms_statistics`
--

CREATE TABLE `lms_statistics` (
  `id` int(11) NOT NULL,
  `user` int(11) NOT NULL,
  `average_time_spent` int(11) DEFAULT 0,
  `total_time_spent` int(11) DEFAULT 0,
  `total_connections` int(11) DEFAULT 0,
  `total_activities_created` int(11) DEFAULT 0,
  `total_activities_viewed` int(11) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `lti_tools` (
  ...
  `public_key_set` varchar(255) NOT NULL,
  `login_url` varchar(255) NOT NULL,
  `redirection_url` varchar(255) NOT NULL,
  `deeplink_url` varchar(255) NOT NULL,
...
INSERT INTO `users` (`id`, `firstname`, `pseudo`, `surname`, `password`, `insert_date`, `update_date`, `picture`, `totp_secret`) VALUES
(1, 'Dev', 'Admin', 'OpenSTEAM', '$2y$10$QwBh68UTaHe4n1Otoz2YO.W2kcecwH6WArMl6BOMPQzo.GAB3T98S', '2023-11-20 10:00:00', '2023-11-20 10:00:00', NULL, NULL);
...
CREATE TABLE `user_classroom_users` (
  `user` int(11) NOT NULL,
  `gar_id` varchar(128) DEFAULT NULL,
  `school_id` varchar(8) DEFAULT NULL,
  `is_teacher` tinyint(1) DEFAULT NULL,
  `mail_teacher` varchar(255) DEFAULT NULL,
  `canope_id` varchar(255) DEFAULT NULL,
  `saml_id` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- --------------------------------------------------------

--
-- Structure de la table `user_connection_history`
--
...
INSERT INTO `user_regulars` (`id`, `bio`, `email`, `telephone`, `confirm_token`, `contact_flag`, `newsletter`, `mail_messages`, `is_active`, `recovery_token`, `new_mail`, `is_admin`, `private_flag`, `stripe_sub_id`, `stripe_cus_id`, `last_sub_datas`, `gifted_subs`, `premium_sub_activated`, `gifted_from`, `from_sso`, `roles`) VALUES
(1, '', 'lms@opensteam.com', NULL, NULL, 1, 1, 0, 1, 'd8f11c860bea06b6201bdfdaf40d0df9', '', 1, 0, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL);
...
--
-- Index pour la table `lms_classroom_sessions`
--
ALTER TABLE `lms_classroom_sessions`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `lms_statistics`
--
ALTER TABLE `lms_statistics`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `classroom_activities_link_classroom_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12851;
...
--
ALTER TABLE `connection_tokens`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12221;

--
-- AUTO_INCREMENT pour la table `interfaces_projects`
--
ALTER TABLE `interfaces_projects`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3006206;
...
--
ALTER TABLE `learn_activities`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4164;
...
--
-- AUTO_INCREMENT pour la table `lms_classroom_sessions`
--
ALTER TABLE `lms_classroom_sessions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `lms_statistics`
--
ALTER TABLE `lms_statistics`
