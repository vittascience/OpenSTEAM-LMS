...
function getTeacherActivity() {
    ...
    let autoCorrectionDisclaimerElt = `<img id="activity-auto-disclaimer" data-bs-toggle="tooltip" src="${_PATH}assets/media/auto-icon.svg?version=VERSIONNUM" title="${i18next.t("classroom.activities.isAutocorrect")}">`
